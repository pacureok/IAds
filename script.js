...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const addMessageToChat = (role, content, midiData = null) => {
        ...
        let messageHTML = `
            ...
            <div class="message-content-wrapper">
                <div class="message-content" style="${isUser ? '' : 'padding: 0; background: transparent;'}">
    ...
    const generateAndDownloadMidi = (midiData) => {
        if (!window.MidiWriter) {
            ...
            showError('MIDI library not available. Please refresh the page.');
            return;
        }
        try {
            ...
            showError("Could not generate MIDI file. The data may be invalid.");
        }
    };
