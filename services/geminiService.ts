    ...
    notes: {
      ...
      items: {
        ...
        properties: {
          pitch: {
            type: Type.STRING,
            description: "The note's pitch in scientific pitch notation (e.g., C4, F#5, Ab3) or a chord as an array of pitches (e.g., ['C4', 'E4', 'G4']). Use sharps for accidentals.",
          },
          duration: {
            type: Type.STRING,
  ...
  try {
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        - Ensure pitches are valid musical notes (e.g., 'C4', 'G#5'). For chords, provide an array of strings.
